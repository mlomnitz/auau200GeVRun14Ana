      ...
      for (int iVz = 0; iVz < nVzs; ++iVz)
      {
        for (int ii = 0; ii < nCent; ++ii)
        {
          for (int jj = 0; jj < nPtBins; ++jj)
          {
            ...
            h1Dca[iParticle][iEta][iVz][ii][jj] = new TH1D(name.Data(),"",nDcas,DcaEdge);
            h1DcaZ[iParticle][iEta][iVz][ii][jj] = new TH1D(nameZ.Data(),"",nDcas,DcaEdge);
            h1DcaXY[iParticle][iEta][iVz][ii][jj] = new TH1D(nameXY.Data(),"",nDcas,DcaEdge);
          }
        }
      }
    }
...
int main(int argc, char **argv)
{
   ...
   TFile* fOut = new TFile("fastSim.Dca.root", "recreate");
